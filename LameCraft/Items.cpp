...
item_t RawPorkchop::getID(){ return 392;}
...
item_t CookedPorkchop::getID(){ return 393;}
...
item_t RawMutton::getID(){ return 394;}
...
item_t CookedMutton::getID(){ return 395;}

RawChicken::RawChicken():BaseItem()
{
	textureRow = 8;
	plane = 9;
	furnItem = 397;
...
item_t RawChicken::getID(){ return 396;}

CookedChicken::CookedChicken():BaseItem()
{
	textureRow = 8;
	plane = 10;
...
item_t CookedChicken::getID(){ return 397;}

Feather::Feather():BaseItem()
{
	textureRow = 14;
	plane = 8;
...
item_t Feather::getID(){ return 398;}

CowEGG::CowEGG():BaseItem()
{
	textureRow = 1;
	plane = 0;
...
item_t CowEGG::getID(){ return 399;}

SheepEGG::SheepEGG():BaseItem()
{
	textureRow = 1;
	plane = 1;
...
item_t SheepEGG::getID(){ return 400;}

ChickenEGG::ChickenEGG():BaseItem()
{
	textureRow = 1;
	plane = 2;
...
item_t ChickenEGG::getID(){ return 401;}

PigEGG::PigEGG():BaseItem()
{
	textureRow = 1;
	plane = 3;
...
item_t PigEGG::getID(){ return 402;}

ZombieEGG::ZombieEGG():BaseItem()
{
	textureRow = 1;
	plane = 4;
...
item_t ZombieEGG::getID(){ return 403;}

CreeperEGG::CreeperEGG():BaseItem()
{
	textureRow = 1;
	plane = 5;
...
item_t CreeperEGG::getID(){ return 404;}

SpiderEGG::SpiderEGG():BaseItem()
{
	textureRow = 1;
	plane = 6;
...
item_t SpiderEGG::getID(){ return 405;}

SpiderEye::SpiderEye():BaseItem()
{
	textureRow = 13;	//Abajo hacia arriba
	plane = 14;			//Izquierda a derecha

	name = "Spider Eye";
}

item_t SpiderEye::getID(){ return 406;}

String::String():BaseItem()
{
	textureRow = 15;
	plane = 8;
	stackable = 1;
...
item_t String::getID(){ return 407;}
...
item_t Bow0::getID(){ return 408;}

Arrow::Arrow():BaseItem()
{
	textureRow = 13;
	plane = 5;
...
item_t Arrow::getID(){ return 409;}

SpidercaveEGG::SpidercaveEGG():BaseItem()
{
	textureRow = 1;
	plane = 7;

	name = "Cave Spider Egg";
}

item_t SpidercaveEGG::getID(){ return 410;}
