...
block_t Cobweb::getID(){ return 39;}
...
block_t BlockOfQuartz::getID(){ return 216;}
...
block_t PillarQuartzBlock::getID(){ return 217;}
...
block_t ChiseledQuartzBlock::getID(){ return 218;}

FireBlock::FireBlock():BaseBlock()
{
    upPlane_x = 13;
    upPlane_y = 15;
...
block_t FireBlock::getID(){ return 219;}

DeadBush::DeadBush():BaseBlock()
{
    upPlane_x = 7;
    upPlane_y = 3;
...
block_t DeadBush::getID(){ return 220;}

CreeperHead::CreeperHead():BaseBlock()
{
    upPlane_x = 7;
    upPlane_y = 3;
...
block_t CreeperHead::getID(){ return 221;}

HellPortal::HellPortal():BaseBlock()
{
    upPlane_x = 12;
    upPlane_y = 15;
...
block_t HellPortal::getID(){ return 222;}
...
block_t Netherrack::getID(){ return 223;}

SoilBlock::SoilBlock():BaseBlock()
{
    upPlane_x = 8;
    upPlane_y = 6;
...
block_t SoilBlock::getID(){ return 224;}
...
block_t Glowstone::getID(){ return 225;}

QuartzOre::QuartzOre():BaseBlock()
{
    upPlane_x = 0;
    upPlane_y = 3;
...
block_t QuartzOre::getID(){ return 226;}

RedSandBlock::RedSandBlock():BaseBlock()
{
    upPlane_x = 10;
    upPlane_y = 11;
...
block_t RedSandBlock::getID(){ return 227;}

WhiteTerracotta::WhiteTerracotta():BaseBlock()
{
    upPlane_x = 10;
    upPlane_y = 9;
...
block_t WhiteTerracotta::getID(){ return 228;}

OrangeTerracotta::OrangeTerracotta():BaseBlock()
{
    upPlane_x = 11;
    upPlane_y = 9;
...
block_t OrangeTerracotta::getID(){ return 229;}

YellowTerracotta::YellowTerracotta():BaseBlock()
{
    upPlane_x = 12;
    upPlane_y = 9;
...
block_t YellowTerracotta::getID(){ return 230;}

Terracotta::Terracotta():BaseBlock()
{
    upPlane_x = 14;
    upPlane_y = 9;
...
block_t Terracotta::getID(){ return 231;}

LightGrayTerracotta::LightGrayTerracotta():BaseBlock()
{
    upPlane_x = 15;
    upPlane_y = 9;
...
block_t LightGrayTerracotta::getID(){ return 232;}

RedTerracotta::RedTerracotta():BaseBlock()
{
    upPlane_x = 13;
    upPlane_y = 9;
...
block_t RedTerracotta::getID(){ return 233;}

BrownTerracotta::BrownTerracotta():BaseBlock()
{
    upPlane_x = 15;
    upPlane_y = 10;
...
block_t BrownTerracotta::getID(){ return 234;}

BlueTerracotta::BlueTerracotta():BaseBlock()
{
    upPlane_x = 10;
    upPlane_y = 10;
...
block_t BlueTerracotta::getID(){ return 235;}

LightBlueTerracotta::LightBlueTerracotta():BaseBlock()
{
    upPlane_x = 11;
    upPlane_y = 10;
	...
	name = "Ligh Blue Terracotta";
}
block_t LightBlueTerracotta::getID(){ return 236;}

CyanTerracotta::CyanTerracotta():BaseBlock()
{
    upPlane_x = 12;
    upPlane_y = 10;
...
block_t CyanTerracotta::getID(){ return 237;}

GreenTerracotta::GreenTerracotta():BaseBlock()
{
    upPlane_x = 14;
    upPlane_y = 10;
...
block_t GreenTerracotta::getID(){ return 238;}

MagnetaTerracotta::MagnetaTerracotta():BaseBlock()
{
    upPlane_x = 12;
    upPlane_y = 11;
	...
	name = "Magneta Terracotta";
}
block_t MagnetaTerracotta::getID(){ return 239;}

PurpleTerracotta::PurpleTerracotta():BaseBlock()
{
    upPlane_x = 14;
    upPlane_y = 11;
...
block_t PurpleTerracotta::getID(){ return 240;}

LimeTerracotta::LimeTerracotta():BaseBlock()
{
    upPlane_x = 13;
    upPlane_y = 11;
...
block_t LimeTerracotta::getID(){ return 241;}

PinkTerracotta::PinkTerracotta():BaseBlock()
{
    upPlane_x = 15;
    upPlane_y = 11;
...
block_t PinkTerracotta::getID(){ return 242;}

GrayTerracotta::GrayTerracotta():BaseBlock()
{
    upPlane_x = 13;
    upPlane_y = 10;
...
block_t GrayTerracotta::getID(){ return 243;}

BlackTerracotta::BlackTerracotta():BaseBlock()
{
    upPlane_x = 11;
    upPlane_y = 11;
...
block_t BlackTerracotta::getID(){ return 244;}
