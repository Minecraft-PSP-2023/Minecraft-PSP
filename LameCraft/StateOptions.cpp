...
void StateOptions::Draw(StateManager* sManager)
{
	...
	switch(menuState)
	{
		case 0:
		{
            ...
            {
                selectPos == 0 ? DrawText(240,129,GU_COLOR(1,1,0,1) ,default_size,"Controles") : DrawText(240,129,GU_COLOR(1,1,1,1) ,default_size,"Controles");
                selectPos == 1 ? DrawText(240,169,GU_COLOR(1,1,0,1) ,default_size,"Mando Analogico") : DrawText(240,169,GU_COLOR(1,1,1,1) ,default_size,"Mando Analogico");
                selectPos == 2 ? DrawText(240,209,GU_COLOR(1,1,0,1) ,default_size,"Regresar") : DrawText(240,209,GU_COLOR(1,1,1,1) ,default_size,"Regresar");

                DrawText(240,29,GU_COLOR(1,1,1,1) ,default_size,"Opciones");
            }
		}
		break;
		case 1://controls
		{
            ...
            if(mRender->GetFontLanguage() == RUSSIAN)
            {
                controlPos == 16 ? DrawText(240,269,GU_COLOR(1,1,0,1) ,default_size,"Regresar") : DrawText(240,269,GU_COLOR(1,1,1,1) ,default_size,"Regresar");
                DrawText(240,29,GU_COLOR(1,1,1,1) ,default_size,"Controles");
            }
		}
		break;
		case 2://analog stick
		{
            ...
            if(mRender->GetFontLanguage() == RUSSIAN)
            {
                ...
                currentAnalogPos >= 4 ? mRender->SetFontStyle(default_size,GU_COLOR(1,1,0.25f,1),0,0x00000200) : mRender->SetFontStyle(default_size,GU_COLOR(1,1,1,1),0,0x00000200);
                mRender->DebugPrint(240,269,"Regresar");

                DrawText(240,29,GU_COLOR(1,1,1,1) ,default_size,"Mando analogico");
            }
		}
		break;
	}
