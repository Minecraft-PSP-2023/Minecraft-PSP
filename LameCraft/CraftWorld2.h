...
public:
	...
	void buildmobVerts();
	void buildCowVerts();
	void buildChickenVerts();
	void buildPigVerts();
	void buildZombieVerts();
	void buildSpiderVerts();
	void buildSpidercaveVerts();
	...
	bool PlayerInFire(Vector3 pos);
	bool PlayerInCobweb(Vector3 pos);
	bool PlayerInHellPortal(Vector3 pos);
	...
	void SpawnSpider(float xx, float yy, float zz);
	void DestroySpider(int id);
	void DestroyAllSpiders();
	
	void SpawnSpidercave(float xx, float yy, float zz);
	void DestroySpidercave(int id);
	void DestroyAllSpidercaves();
	...
	void SpawnChicken(float xx, float yy, float zz);
	void DestroyChicken(int id);
	...
	char animationFireFrame;//fire
	char animationHellPortalFrame;
    char animationLavaFrame;
    bool animationLavaStep;

    float spawnZombiesTimer;
    float spawnSpidersTimer;
    float spawnSpidercavesTimer;
    float spawnCowsTimer;
	float spawnChickensTimer;
	float spawnPigsTimer;
    float spawnCreeperTimer;
    float spawnSheepTimer;

    int textureWaterAnimationId;
	int textureFireAnimationId;//fire
	int textureHellPortalAnimationId;
	...
	Vector3 forestBiomePosition;
	
	Vector3 desertBiomePosition;
	float snowBiomeRadius;
	
	float forestBiomeRadius;
    ...
    std::vector<Spidercave*> mSpidercaves;
    ...
    TexturesPSPVertex *headCapaVertices;
	...
	// for spiders
    TexturesPSPVertex *spiderCabezaVertices;
    TexturesPSPVertex *spiderCuelloVertices;
    TexturesPSPVertex *spiderCuerpoVertices;
    TexturesPSPVertex *spiderPiernaVertices;
	...
	// for chickens
    TexturesPSPVertex *chickenBodyVertices;
	TexturesPSPVertex *chickenAlaVertices;
    TexturesPSPVertex *chickenHeadVertices;
    TexturesPSPVertex *chickenLegVertices;
    TexturesPSPVertex *chickenPicosVertices;
	
    // for pigs
    TexturesPSPVertex *pigBodyVertices;
    TexturesPSPVertex *pigHeadVertices;;
    TexturesPSPVertex *pigLegVertices;
    TexturesPSPVertex *pigNosesVertices;
