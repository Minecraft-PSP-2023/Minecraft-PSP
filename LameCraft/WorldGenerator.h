...
{
	public:
		void initRandompMap(int worldSize, int worldHeight, int chunkSize, CraftWorld *world, bool makeTrees,bool makeDungeons,bool makeBonus,bool makeCaves, unsigned int seedII, int worldType);
		...
		void initPools(int WORLD_SIZE, CraftWorld *world);
		...
		void initCofreBonus(int WORLD_SIZE, CraftWorld *world);
		void initDungeons(int WORLD_SIZE, CraftWorld *world);
		void initEstructuras(int WORLD_SIZE, CraftWorld *world);
