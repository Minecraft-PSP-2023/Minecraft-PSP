...
namespace Aurora
{
	namespace Graphics
	{
		Particle::Particle(CraftWorld* world, std::string _name, Vector3 _position)
		{
			...
			if(name == "heart")
            {
                texture = TextureHelper::Instance()->GetTexture(TextureHelper::heartTexture);

                SetMaxLiveTime(2000);
				switch(rand() % 6)
                {
                    case 0 : SetLiveTime(500,1000); break;
                    case 1 : SetLiveTime(1500,2000); break;
                    case 2 : SetLiveTime(1500,2000); break;
                    case 3 : SetLiveTime(2000,2500); break;
                    case 4 : SetLiveTime(2000,2500); break;
                    default: SetLiveTime(1000,1500); break;
                }
				
				switch(rand() % 3)
				{
					case 0 : SetScale(0.15f,0.15f); break;
					case 1 : SetScale(0.18f,0.18f); break;
					default : SetScale(0.2f,0.2f); break;
				}
